/******************************************************************************
  ...
  Modified 2016-03-07 by Michael Gries
  dedicated to Sarah & Daniel
...
#define RESETPIN 12  // NodeMCU pin 6

//#define FMSTATION 10230      // 10230 == 102.30 MHz
#define FMSTATION 9800         //  9800 ==  98.00 MHz
...
void setup() {
  ...
  radio.beginRDS();
  radio.setRDSstation("HEF-SG98");
  radio.setRDSbuffer( "Sarah & Daniel !");
